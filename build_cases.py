...
{BAGS_CATALOG_HTML}
  ...
  <dialog class="supply-notice" id="supply-notice" aria-labelledby="supply-notice-title" aria-describedby="supply-notice-desc">
    ...
    <p id="supply-notice-desc" class="supply-notice__body">
      Anything marked <strong>Special order</strong> is fulfilled after we place the order with our supplier.
      <strong class="supply-notice__estimate">Special order items typically ship within 1 to 2 weeks.</strong>
    </p>
    <form method="dialog">
